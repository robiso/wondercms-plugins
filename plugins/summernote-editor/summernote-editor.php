...
function loadSummerNoteJS($args) {
    ...
    if ($Wcms->loggedIn) {
        ...
        <script src="plugins/summernote-editor/js/admin.js" type="text/javascript"></script>
        <script src="plugins/summernote-editor/js/files.js" type="text/javascript"></script>
EOT;
        $args[0] .= $script;
    }
    return $args;
...
function loadSummerNoteCSS($args) {
    ...
    if ($Wcms->loggedIn) {
        ...
        <link rel="stylesheet" href="plugins/summernote-editor/css/admin.css" type="text/css" media="screen">
EOT;
        $args[0] .= $script;
    }
    return $args;
